        ...
        <div className="container">
            ...
            <form method="post">
                ...
                <div className="text-center panel-body">
                    <a asp-action="Index" className="btn btn-sm btn-primary">Back</a>
                    <button type="submit" className="btn btn-sm btn-primary" onClick={(e) => handleSubmit(e)}> Create Project</button>
                </div>
            </form>
        </div>
    )
